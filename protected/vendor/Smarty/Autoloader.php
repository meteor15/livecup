...
class Smarty_Autoloader
{
    ...
    private static $syspluginsClasses = array(
        ...
        'smarty_internal_parsetree_template'    => true,
        'smarty_internal_templateparser'        => true,
        'smarty_internal_templatelexer'         => true,
        'smarty_internal_smartytemplatecompiler'=> true,
        'smarty_internal_templatecompilerbase'  => true,
